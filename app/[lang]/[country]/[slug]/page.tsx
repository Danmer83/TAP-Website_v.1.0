 ...
 * This route handles articles without cities: /en/thailand/article-slug
 */
...
/**
 * Dynamic route page component for articles without cities
 * Handles URLs like: /en/thailand/article-slug
 */
export default async function ArticlePage({ params }: PageProps) {
  ...
  // Only show articles without cities on this route
  if (article.city) {
    notFound()
  }
